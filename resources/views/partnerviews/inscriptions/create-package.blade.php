...
@section('contenido')
<div class="container">
    <form action="{{route('partner.inscriptions.storePackage')}}" method="POST">
        {{ csrf_field() }}
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select name="paquete" id="paquete_select"
                                        class="form-control form-control-sm{{ $errors->has('paquete') ? ' is-invalid' : '' }}">
                                        <option value="">Seleccionar</option>
                                        @foreach($paquetes as $paquete)
                                        <option value="{{$paquete->id}}">{{$paquete->nombrePaquete}}</option>
                                        @endforeach
                                    </select>
                                    {!!$errors->first('paquete','<span
                                        class="error invalid-feedback">:message</span>')!!}
                                </div>
                                <div class="form-group">
                    ...
                    <div class="col-md-6 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body table-responsive p-0" style="height:200px;">
                                <table class="table table-head-fixed table-striped table-sm"
                                    id="table_resumen_carrito_package">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="3" align="center">No tiene productos en el carrito</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control form-control-sm inputCentrado"
                                                    id="subtotal_resumen_carrito_paquete" name="subtotal" value="0"
                                                    readonly>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control form-control-sm inputCentrado"
                                                    id="igv_resumen_carrito_paquete" name="impuesto" value="0" readonly>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control form-control-sm inputCentrado"
                                                    id="total_resumen_carrito_paquete" name="total" value="0" readonly>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control form-control-sm inputCentrado"
                                                    id="puntos_resumen_carrito_paquete" name="total_puntos" value="0"
                                                    readonly>
                                            </td>
                                        </tr>
                                    </tfoot>
