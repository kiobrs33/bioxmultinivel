    ...
    <div class="row justify-content-center">
        <div class="col-sm-12 col-md-10 col-lg-7">
            ...
            <div class="card card-secondary mt-3">
                ...
                <form action="{{route('admin.ranks.update')}}" method="POST">
                    {{ csrf_field() }}
                    <input type="hidden" value="{{$rango->slugRango}}" name="slug_rango">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="nombre"
                                ...
                                value="{{$rango->nombreRango}}">
                            {!!$errors->first('nombre','<span class="error invalid-feedback">:message</span>')!!}
                        </div>
                        <div class="form-group">
                            <label>Descripcion</label>
                            <textarea name="descripcion" rows="2"
                                class="form-control form-control-sm inputCentrado{{ $errors->has('descripcion') ? ' is-invalid' : '' }}">{{$rango->descripcionRango}}</textarea>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="puntaje_personal"
                                        ...
                                        value="{{$rango->puntajePersonalRango}}">
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="puntaje_grupal"
                                        ...
                                        value="{{$rango->puntajeGrupalRango}}">
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="puntaje_directos"
                                        ...
                                        value="{{$rango->puntajeDirectosRango}}">
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="activos_franquiciados"
                                        ...
                                        value="{{$rango->activosFranquiciadosRango}}">
