            ...
            <div class="card">
                <div class="card-header">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-auto">
                            <a href="{{route('admin.packages.create')}}" class="btn btn-success btn-block btn-sm">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="packages" class="table table-striped table-sm">
                            <thead>
                                <tr>
                                    <th width="30px" class="filasTable">ID</th>
                                    <th class="filasTable">Nombre paquete</th>
                                    <th>&nbsp;</th>
                                </tr>
                            </thead>
                        </table>
