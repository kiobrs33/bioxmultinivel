    ...
    <div class="card">
        <div class="card-header">
            <div class="row justify-content-between">
                ...
                <div class="col-auto">
                    <a href="{{route('admin.employees.create')}}" class="btn btn-success btn-block btn-sm">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="employees" class="table table-striped table-sm">
                    <thead>
                        <tr>
...
$(document).ready(function() {
    $('#employees').DataTable({
        ...
        "columns": [{
            ...
            {
                data: 'nombresTrabajador'
            },
            {
                data: 'apellidoPaternoTrabajador'
            },
            {
                data: 'apellidoMaternoTrabajador'
            },
            {
                data: 'dniTrabajador'
            },
            {
                data: 'telefonoTrabajador',
            },
            {
                data: 'slugTrabajador',
            }
